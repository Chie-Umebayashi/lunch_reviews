...
export default function ReviewDetail({ review, onEdit, onDelete }: ReviewDetailProps) {
  return (
    <section className="h-[40%] p-6 border-b border-gray-100 overflow-y-auto bg-white">
